; Inno Setup source file for new_steve Scripts
[Setup]
AppName=new_steve Scripts
AppVerName=new_steve Scripts
DefaultDirName={pf}\new_steve Scripts
DefaultGroupName=new_steve Scripts
OutputBaseFilename=js_installer_setup
OutputDir=Output
Compression=lzma
...
[Files]
Source: "InnoSetup.j*"; Flags: dontcopy
Source: "*.tab"; DestDir: "{app}"
Source: "*.cnf"; DestDir: "{app}"

[Icons]
Name: "{group}\Uninstall new_steve Scripts"; Filename: "{uninstallexe}"
