...
c:\windows\Microsoft.NET\Framework\v4.0.30319\csc.exe /platform:x86 /out:EdSharp.exe /nologo /t:winexe /r:Tektosyne.dll /r:IronCOM.dll /r:Microsoft.JScript.dll /r:eval.dll /r:VB.dll /r:Microsoft.VisualBasic.dll /r:Microsoft.VisualBasic.Compatibility.dll EdSharp.cs >temp.txt
if errorlevel 1 goto end
c:\windows\Microsoft.NET\Framework\v4.0.30319\csc.exe /platform:x64 /out:EdSharp64.exe /nologo /t:winexe /r:Tektosyne.dll /r:IronCOM.dll /r:Microsoft.JScript.dll /r:eval.dll /r:VB.dll /r:Microsoft.VisualBasic.dll /r:Microsoft.VisualBasic.Compatibility.dll EdSharp.cs >nul  
