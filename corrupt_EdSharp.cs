...
System.IO.File.Delete(App.IndentModeFile);
...
// Ini.WriteValue(App.IniFile, "Data", "IndentMode", (this.RTB.IndentMode ? "1" : "0"), false);
...
// Ini.WriteValue(App.IniFile, "Data", "IndentMode", (rtb.IndentMode ? "1" : "0"), false);
bool b = System.IO.File.Exists(App.IndentModeFile);
...
sText = "EdSharp 4.0\nFebruary 20, 2016\n\n";
sText += "Copyright 2007 - 2016 by Jamal Mazrui\nGNU Lesser General Public License (LGPL)\n\n";
...
bool b = System.IO.File.Exists(App.IndentModeFile);
if (b && !this.IndentMode) System.IO.File.Delete(App.IndentModeFile);
else if (!b && this.IndentMode) System.IO.File.Create(App.IndentModeFile).Close();
