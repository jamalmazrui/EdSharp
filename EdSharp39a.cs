//EdSharp 3.2
// June 10, 2010
//Copyright 2007 - 2010 by Jamal Mazrui
...
[assembly: AssemblyCopyright("Copyright 2007 - 2010 by Jamal Mazrui")]
...
Dialog.Show(sEncoding.Replace("-", "").ToLower(), "");
if (sEncoding.Replace("-", "").ToLower() == "utf8n") en = new UTF8NEncoding();
...
String sExe = Path.Combine(App.ProgramDir, @"Convert\astyle\bin\astyle.exe");
...
// string sCommand = sExe + " -c " + sCfg + " -f " + sSourceFile + " -o " + sTargetFile;
        ...
        string sIndent = App.ReadOption("IndentUnit", "  ");
        sIndent = Util.Literalize(sIndent);
string sCommand = sExe + " " + sSourceFile;
...
sText = "EdSharp 3.2\n\nJune 10, 2010\n\n";
sText += "Copyright 2007 - 2010 by Jamal Mazrui\n\nModified GPL License";
...
new string EncodingName, CodePage;
public UTF8NEncoding() {
// base.UTF8Encoding();
this.EncodingName = "UTF-8N";
this.CodePage = "65002";
} // UTF8NEncoding constructor
} // UTF8N class
