...
C:\Roslyn\csc.exe /platform:x86 /out:EdSharp.exe /nologo /t:winexe /r:Tektosyne.dll /r:IronCOM.dll /r:Microsoft.JScript.dll /r:eval.dll /r:VB.dll /r:Microsoft.VisualBasic.dll /r:Microsoft.VisualBasic.Compatibility.dll EdSharp.cs >temp.txt
